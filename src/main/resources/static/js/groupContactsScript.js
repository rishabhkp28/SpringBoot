/* ═══════════════════════════════════════════════════════════
   SmartCM — GROUP CONTACTS PAGE SCRIPT
...
(function () {
    ...
    /* ══════════════════════════════════════════════════════
       1. CONTACT ROW HOVER — CSS handles the translateX,
          JS adds the left accent border on mouseenter
       ══════════════════════════════════════════════════════ */
    ...
    document.addEventListener('DOMContentLoaded', () => {
        initContactRowFx();
        initRipple();
        console.log('%cSmartCM Group Contacts · Page Ready', 'color:#e8a020;font-family:serif;font-style:italic;font-size:12px');
    });
