/* ═══════════════════════════════════════════════════════════
   SmartCM — FAVOURITE CONTACTS PAGE SCRIPT
...
(function () {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        initContactRowFx();
        initRipple();
        console.log('%cSmartCM Favourite Contacts · Page Ready', 'color:#e8a020;font-family:serif;font-style:italic;font-size:12px');
    });
